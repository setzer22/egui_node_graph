...
/// Files in the 'examples' directory need to have a main function, but this file is only meant to be included in framework-specific examples like 'eframe' or 'bevy'
#[allow(dead_code)]
fn main() {
    panic!("This is not an example");
}
